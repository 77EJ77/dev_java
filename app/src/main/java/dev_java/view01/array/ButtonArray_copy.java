...
public class ButtonArray_copy implements ActionListener {
  // 선언부
  ...
  String jbtns_label[] = { "새 게임", "정답", "지우기", "나가기" };

  // 생성자
  public ButtonArray_copy() {
  ...
  public void initDisplay() {
    ...
    for (int i = 0; i < jbtns.length; i++) {
      ...
      jbtns[i].setBackground(new Color(255, 255, 255));
      jbtns[i].setForeground(new Color(000, 000, 000));
      jp_east.add(jbtns[i]);
    }
