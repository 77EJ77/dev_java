...
public class Pride {
  ...
  public static void main(String[] args) {
    // 변수이름앞에 static이 있으면 인스턴스화 없이도 호출이 가능함.
    ...
    // myCar.carColor = "보라색"; -> 이 위치에 설정하면 컴파일은 되나 NullPointerException 런타임에러 뜸.
    // 구현체가 없을 때.
    // insert here - 여기서는 자동차 색상을 출력할 수 있나요?
    myCar = new Pride();// 새로운 주소번지를 갖는다.
    System.out.println("28번 라인에서 ====> " + myCar);
    System.out.println(myCar == myCar);// 무엇을 비교하는 문장인가요? true가 출력되는 이유를 말해보세요.
    // insert here
